...
class Window_Base < Window
  ...
  def hp_gauge_color1;   text_color(18);  end;    # HP ゲージ 1
  def hp_gauge_color2;   text_color(10);  end;    # HP ゲージ 2
  def mp_gauge_color1;   text_color(9);  end;    # MP ゲージ 1
  def mp_gauge_color2;   text_color(1);  end;    # MP ゲージ 2
